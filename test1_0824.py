...
def boundary_detection(img):
    ...
    line_result=cv2.HoughLines(result,1,np.pi/180,200)[:,0,:]
...
test_img=cv2.imread("C:/Users/53075/Pictures/SMP_test/10.jpg",cv2.IMREAD_GRAYSCALE)
test_img=cv2.resize(test_img,dsize=(Image_length,Image_width))
new_result=boundary_detection(test_img,Image_length,Image_width)
